(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_column_details.json", 2035094],
      ["data/game_data_part_1.csv", 43099877],
      ["data/game_data_part_10.csv", 42891969],
      ["data/game_data_part_2.csv", 42891059],
      ["data/game_data_part_3.csv", 42897549],
      ["data/game_data_part_4.csv", 42900841],
      ["data/game_data_part_5.csv", 42888623],
      ["data/game_data_part_6.csv", 42892563],
      ["data/game_data_part_7.csv", 42897280],
      ["data/game_data_part_8.csv", 42888631],
      ["data/game_data_part_9.csv", 42885942],
