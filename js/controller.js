(() => {
	...
	const filePathToSizeMap = new Map([
		...
		["data/game_column_categories.json", 261118],
		["data/game_column_details.json", 951797],
		["data/game_data_part_1.csv", 52435410],
		...
		["data/tag_quick_search_patterns.json", 1017425],
	]);
