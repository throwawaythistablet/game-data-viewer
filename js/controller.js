(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_column_details.json", 2048220],
      ["data/game_data_part_1.csv", 43664720],
      ["data/game_data_part_10.csv", 43439516],
      ["data/game_data_part_2.csv", 43470555],
      ["data/game_data_part_3.csv", 43462742],
      ["data/game_data_part_4.csv", 43465607],
      ["data/game_data_part_5.csv", 43468649],
      ["data/game_data_part_6.csv", 43471586],
      ["data/game_data_part_7.csv", 43460887],
      ["data/game_data_part_8.csv", 43467906],
      ["data/game_data_part_9.csv", 43466882],
      ["data/game_keys.json", 1349843],
      ["data/game_thumbnails.json", 20179185],
      ["data/tag_quick_search_patterns.json", 5145207],
    ]);
