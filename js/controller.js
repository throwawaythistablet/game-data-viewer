(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_column_details.json", 2035336],
      ["data/game_data_part_1.csv", 41948594],
      ["data/game_data_part_10.csv", 41951916],
      ["data/game_data_part_11.csv", 6977015],
      ["data/game_data_part_2.csv", 41944734],
      ["data/game_data_part_3.csv", 41944509],
      ["data/game_data_part_4.csv", 41944495],
      ["data/game_data_part_5.csv", 41951606],
      ["data/game_data_part_6.csv", 41943096],
      ["data/game_data_part_7.csv", 41945017],
      ["data/game_data_part_8.csv", 41958458],
      ["data/game_data_part_9.csv", 41958919],
      ["data/game_keys.json", 1330777],
      ["data/game_thumbnails.json", 19891731],
      ["data/tag_quick_search_patterns.json", 5113940],
    ]);
