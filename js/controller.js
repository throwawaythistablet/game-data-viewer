(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_data_part_1.csv", 52429109],
      ["data/game_data_part_2.csv", 52429800],
      ["data/game_data_part_3.csv", 52431546],
      ["data/game_data_part_4.csv", 23939723],
      ["data/game_keys.json", 1253286],
