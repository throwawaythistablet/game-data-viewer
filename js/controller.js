(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_column_categories.json", 612988],
      ["data/game_column_details.json", 2035155],
      ["data/game_data_part_1.csv", 41953019],
      ["data/game_data_part_10.csv", 41951963],
      ["data/game_data_part_11.csv", 7024971],
      ["data/game_data_part_2.csv", 41946607],
      ["data/game_data_part_3.csv", 41946136],
      ["data/game_data_part_4.csv", 41945571],
      ["data/game_data_part_5.csv", 41953554],
      ["data/game_data_part_6.csv", 41944108],
      ["data/game_data_part_7.csv", 41945883],
      ["data/game_data_part_8.csv", 41945463],
      ["data/game_data_part_9.csv", 41945538],
      ["data/game_keys.json", 1330777],
      ["data/game_thumbnails.json", 19891731],
      ["data/tag_quick_search_patterns.json", 5091983],
    ]);
