(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_column_categories.json", 302553],
      ["data/game_column_details.json", 1156692],
      ["data/game_data_part_1.csv", 52430854],
      ["data/game_data_part_2.csv", 52437132],
      ["data/game_data_part_3.csv", 52435729],
      ["data/game_data_part_4.csv", 52437995],
      ["data/game_data_part_5.csv", 35251197],
      ["data/game_keys.json", 1275409],
