(() => {
    ...
    const filePathToSizeMap = new Map([
      ...
      ["data/game_data_part_1.csv", 41944662],
      ["data/game_data_part_2.csv", 41943416],
      ["data/game_data_part_3.csv", 41943166],
      ["data/game_data_part_4.csv", 41952970],
      ["data/game_data_part_5.csv", 41945206],
      ["data/game_data_part_6.csv", 41948593],
